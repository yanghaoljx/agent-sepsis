...
class PineconeManagment:
    ...
    def creating_index(self, index_name: str, docs: Document, dimension=384, metric="cosine", embedding = hf_embedding):
    ...
    def loading_vdb(self, index_name: str, embedding=hf_embedding):
